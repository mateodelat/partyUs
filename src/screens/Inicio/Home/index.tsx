  ...
  function onPay(
    req = {
      body: {
        ...
        event_date: "2022-10-10T13:16:17-05:00",
        transaction: {
          id: "tr318ht9yfvplvpuw3yf",
          authorization: null,
          operation_type: "in",
          transaction_type: "charge.succeeded",
          status: "completed",
          conciliated: false,
          creation_date: "2022-10-10T13:16:17-05:00",
          operation_date: "2022-10-10T13:16:17-05:00",
          description: "Pago 1 personas mateo1 en bla bla bla",
          error_message: null,
          order_id: "charge>>>8cead74d-ad9f-4483-9411-be07f21a0270",
          customer_id: "abd7tq7wjmbydapxc486",
          due_date: "2022-10-11T13:16:17-05:00",
          amount: 410,
          payment_method: {
            type: "store",
            reference: "1010100074345402",
            barcode_url:
              "https://sandbox-api.openpay.mx/barcode/1010100074345402?width=1&height=45&text=false",
          },
          currency: "MXN",
          method: "store",
        },
    ...
    res = { json: console.log, status: (e: any) => null }
  ) {
    ...
    try {
      ...
      if (method !== "store") {
        console.log("Transaccion no es pago en efectivo");
      ...
      if (!reservaID) {
        throw new Error("Error no se encontro reserva ID en los datos");
      }
      ...
      API.graphql({
        ...
        // Obtener el id pagos de organizador y cliente
        const { userPaymentID: clientPaymentIDFetched } = r.usuario;
        const { userPaymentID: ownerPaymentIDFetched } = r.evento.creator;
        ...
        const { pagadoAlOrganizador, comision } = r;
        ...
        // Crear transferencia al organizador
        fetchFromOpenpay({
        ...
        API.graphql({
          ...
          console.log("Reserva actualizada con exito: " + r);
        });
      });
    } catch (e) {
      console.log(e);
