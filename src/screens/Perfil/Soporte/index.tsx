...
import { AsyncAlert, azulClaro, verde } from "../../../../constants";
...
export default function () {
  function handleWhatsapp() {
    AsyncAlert(
      ...
      if (!r) return;
      Linking.openURL(
        "whatsapp://send?text=Hola, tengo un problema con partyus: &phone=5213324963705"
      ).catch((e) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={handleWhatsapp} style={styles.buttonContainer}>
        <FontAwesome name="whatsapp" size={30} color={verde} />
      ...
      <TouchableOpacity onPress={handleMail} style={styles.buttonContainer}>
        <Feather name="mail" size={30} color={verde} />
